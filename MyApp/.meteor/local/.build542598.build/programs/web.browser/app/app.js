var require = meteorInstall({"client":{"pages":{"template.header.js":function(){
...
Template["header"] = new Template("Template.header", (function() {                                                   // 3
  ...
  return [ HTML.DIV({                                                                                                // 5
    ...
    class: "collapse navbar-collapse text-right center-block",                                                       // 13
    id: "bs-example-navbar-collapse-1"                                                                               // 14
  }, "\n\t\t\t\t", HTML.UL({                                                                                         // 15
    class: "nav navbar-nav pull-right center-block ",                                                                // 16
    id: "rightnav"                                                                                                   // 17
  }, "\n\t\t\t\t\t", HTML.LI(HTML.A({                                                                                // 18
    href: function() {                                                                                               // 19
      return Spacebars.mustache(view.lookup("pathFor"), "Home");                                                     // 20
    },                                                                                                               // 21
    style: "color:#FFFFFF;",                                                                                         // 22
    id: "home"                                                                                                       // 23
...
Template["main"] = new Template("Template.main", (function() {                                                       // 3
  var view = this;                                                                                                   // 4
  return [ HTML.Raw("<h1>This is main</h1>\n\n"), Spacebars.include(view.lookupTemplate("showStudents")) ];          // 5
}));                                                                                                                 // 6
                                                                                                                     // 7
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

}},"js":{"bootstrap.js":function(require){
